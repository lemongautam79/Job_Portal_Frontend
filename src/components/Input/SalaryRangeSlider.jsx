        ...
        <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input
                        type="number"
                        className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opcacity-50"
                        placeholder="0"
                        min="0"
                        step="1000"
                        value={minSalary || ""}
            ...
            {(minSalary || maxSalary) ? (
                <div className="text-sm text-gray-600 bg-grya-50 px-3 py-2 rounded">
